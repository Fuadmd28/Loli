...
if (!mime) throw 'Send Foto Dengan Caption .jadianime'
m.reply(wait)
...
try {
        ...
        await m.reply('Terjadi Kesalahan, Cobalah Untuk Memakai Foto Yang Lebih Jelas')
    }
delete conn.toanime[m.chat];
}
handler.command = /^(anime2d)$/i
handler.help = ['anime2d']
handler.tags = ['ai']
