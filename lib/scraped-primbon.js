     ...
     return new Promise((t, n) => { 
       axios({ 
         ...
         try { 
           n = { 
             ...
             message: { 
               ...
               energi_positif: { 
                 ...
                 persentase: 
                   i.split("%ENERGI NEGATIF")[0].split("% = ")[1] + "%", 
               }, 
               energi_negatif: { 
           ...
           n = { status: !1, message: "ERROR! No. Handphone Tidak Valid!" }; 
         } 
         t(n); 
       }); 
     }); 
           ...
           t = { 
             ...
             message: { 
               ...
               simbol_tarot: e 
                 ...
                 .split("Kartu tarot")[0], 
               image: 
                 "https://primbon.com/" + n("#body").find("img").attr("src"), 
