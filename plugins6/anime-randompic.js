...
handler.help = ['maid','waifu','marin-kitagawa','mori-calliope','raiden-shogun','oppai','selfies','uniform','ass','milf','oral','paizuri','ecchi','ero']
handler.tags = ['anime']
handler.command = /^(maid|waifu|marin-kitagawa|mori-calliope|raiden-shogun|oppai|selfies|uniform|ass|milf|oral|paizuri|ecchi|ero)$/i
handler.limit = true
